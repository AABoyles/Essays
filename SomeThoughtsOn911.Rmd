...
Every day since 9-11-2001, [approximately `r dailyGrossMortality` people have died](https://en.wikipedia.org/wiki/Mortality_rate). There have been `r daysSince` days since then. `formatC(signif(daysSince * dailyGrossMortality, 2), format="d", big.mark=',')` people have died. That's more than the [entire population of Europe](https://www.google.com/search?q=Population+of+Europe), snuffed out. Try (and fail) to wrap your head around that number. It's just too overwhelming. Our brains don't (and can't) work that way.
