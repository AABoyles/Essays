...
```{r}
knitr::kable(read.csv(textConnection('Month,14,15,16,17,18,19
May,"-","15","16","-","-","19"
June,"-","-","","17","18","-"
July,"14","-","16","-","-","-"
August,"14","15","-","17","-","-"')), )
