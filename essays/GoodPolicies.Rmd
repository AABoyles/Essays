...
Status: **Perpetually Incomplete**, Epistemic Status: **Uncertain**, Last Revision: **`r file.info("GoodPolicies.Rmd")$mtime`**
...
End development and cancel purchase orders for all F-35s.
...
Mandate vaccinations for all public school attendees.
...
Replace cursive writing curriculum with typing skills on Dvorak keyboards.
...
[latex]Tax Rate=frac{72}{1+e^{7-frac{x}{9}}}[/latex]
...
Expand SNAP benefits while enacting stricter guards to prevent SNAP benefits from going to soft drinks, candy, cookies, snack crackers, and ice cream.

# Open Borders

Stop the flow of illegal immigrants by letting everyone in through legal checkpoints.
Fire CBP Agents and their managers on any allegation of wrong-doing. Aggressively pursue criminal charges against agents.
...
Begin construction on Petawatt-hour Nuclear Reactors (What? How?)
Mandate Solar Energy production standards for all new, federally-constructed buildings.
Expand existing incentive programs for solar electricity.
...
Publicly fund all elections (i.e. Legislate around Citizens United).
Make everyone vote in every election. Voters respond to their sense of malcontentment by abstaining from voting.
...
Amend the constitution to restructure the Supreme Court in the following ways:
...
Institute the following procedural changes:
