...
Anthropic Logic (Observer Selection Effects)
...
We observe that the Cold War between the United States and the Soviet Union did not culminate in a nuclear war.
...
The anthropic logic here is that an observer is vastly more likely to live in a world where catastrophic nuclear war has not occurred, as such a war would vastly reduce the number of observers capable of making the observation. Stated differently, it’s way more likely that an observer observes a universe in which a global thermonuclear war was never fought than that an observer observes a universe in which it has.
