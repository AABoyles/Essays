...
meta <- list(
  "Status" = "Complete",
  "Last Revision" = file.info("about.Rmd")$mtime
)
infobox(meta)
```

Hi, I’m Tony Boyles. I make a living by doing Data Science.
...
* R for Statistics: ggplot2 for Static data visualizations, dplyr and tidyr for data wrangling.
...
* Javascript for Web: D3 for any Data Visualization, OpenLayers or Leaflet for Mapping, jQuery and Underscore because Javascript is excruciating without them.
...
I do like gadgets: I’d love to have an HTC Vive and Makerbot Replicator to play with. Oh, a Tesla Model S100D with Autopilot.
